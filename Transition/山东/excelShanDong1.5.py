...
def exceltoDataFrame(filename : str):
    data1 = pd.read_excel(filename,sheet_name='济南115',header=None)
    data2 = pd.read_excel(filename,sheet_name='青岛87',header=None)
    data3 = pd.read_excel(filename,sheet_name='淄博35',header=None)
    data4 = pd.read_excel(filename,sheet_name='枣庄14',header=None)
    data5 = pd.read_excel(filename,sheet_name='东营32',header=None)
    data6 = pd.read_excel(filename,sheet_name='烟台49',header=None)
    data7 = pd.read_excel(filename,sheet_name='潍坊39',header=None)
    data8 = pd.read_excel(filename,sheet_name='济宁25',header=None)
    data9 = pd.read_excel(filename,sheet_name='泰安25',header=None)
    data10 = pd.read_excel(filename,sheet_name='威海26',header=None)
    data11 = pd.read_excel(filename,sheet_name='日照13',header=None)
    data12 = pd.read_excel(filename,sheet_name='莱芜10',header=None)
    data13 = pd.read_excel(filename,sheet_name='临沂22',header=None)
    data14 = pd.read_excel(filename,sheet_name='德州21',header=None)
    data15 = pd.read_excel(filename,sheet_name='聊城18',header=None)
    data16 = pd.read_excel(filename,sheet_name='滨州20',header=None)
    data17 = pd.read_excel(filename,sheet_name='菏泽22',header=None)
    data18 = pd.read_excel(filename,sheet_name='协会代管',header=None)
    data = pd.concat([data1,data2,data3,data4,data5,data6,data7,data8,data9,data10,data11,data12,data13,data14,data15,data16,data17,data18]).reset_index().drop('index',axis=1)
    listIndex = []
...
if __name__ == '__main__':
    file = '2018年山东省注册会计师任职资格检查合格名单.xls'
