...
def word_extraction_shanghai_table(province:str,year:str): #结果函数
...
def getTableValue(path:str):#读取各事务所中会计师姓名
    ...
    return shiwusuo_name_tables #结果用

    #return shiwusuo_name_tables,single_word #测试用
...
if __name__ == "__main__":
    ...
    path = '上海市2019年度通过任职资格检查注册会计师名单（第一批）.docx' #第一步输入目标路径
    ...
    #table = getTableValue(path)
    
    table,simple = getTableValue(path)
    ...
    #------------------------一
    '''
    word_extraction_shanghai_table('上海', '2019')
